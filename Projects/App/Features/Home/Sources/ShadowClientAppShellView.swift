...
let settingsTelemetryRuntime: SettingsDiagnosticsTelemetryRuntime
    ...
    @AppStorage(ShadowClientAppSettings.StorageKeys.audioSynchronizationPolicy) var audioSynchronizationPolicyRawValue = ShadowClientAudioSynchronizationPolicy.videoSynchronized.rawValue
