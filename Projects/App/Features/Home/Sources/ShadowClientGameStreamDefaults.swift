...
public enum ShadowClientVideoDecoderDefaults {
    ...
    public static let minimumInFlightDecodeRequests = 4
    public static let maximumInFlightDecodeRequests = 36
    ...
    public static let inFlightDecodeBacklogBoostDivisor = 3
    public static let inFlightDecodeMaximumBacklogBoost = 10
    public static let inFlightDecodeInstabilityGraceFrameWindow = 3.0
    public static let inFlightDecodeBacklogBoostInstabilityDampingRatio = 0.5
    public static let decodePacingMinimumMultiplier = 0.55
...
public enum ShadowClientRealtimeSessionDefaults {
    ...
    public static let videoReceiveQueueMaximumFrameWindow = 6
    ...
    public static let videoDecodeQueueMaximumCapacity = 72
    ...
    public static let videoDepacketizerDecodeQueueShedHighWatermark = 14
    ...
    public static let decoderOutputStallThresholdSeconds: TimeInterval = 1.6
    ...
    public static let videoQueuePressureRecoveryMinimumOutputStallSeconds: TimeInterval = 0.9
    ...
    public static let videoRenderSubmitPacingToleranceRatio: Double = 0.90
    public static let videoRenderSubmitDropLogInterval = 240
