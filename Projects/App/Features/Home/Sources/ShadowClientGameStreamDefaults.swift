...
public enum ShadowClientRealtimeSessionDefaults {
    ...
    public static let videoDecodeQueueConsumerPressureTrimRatio = 0.50
    public static let videoDecodeQueueConsumerPendingRecoveryTrimRatio = 0.40
    public static let videoDecodeQueueProducerTrimRatio = 0.50
    ...
    public static let videoRenderSubmitPacingHighRefreshThresholdFPS = 90
    public static let videoRenderSubmitPacingHighRefreshToleranceRatio: Double = 0.72
    public static let videoRenderSubmitPacingPressureToleranceRatio: Double = 0.68
    public static let videoRenderSubmitBacklogThresholdRatio: Double = 0.30
