...
public enum ShadowClientVideoDecoderDefaults {
    ...
    public static let minimumInFlightDecodeRequests = 3
    public static let maximumInFlightDecodeRequests = 24
    public static let inFlightDecodeCoreScalingDivisor = 3.0
    public static let inFlightDecodeMaximumCoreScale = 2.5
    public static let inFlightDecodeWorkloadGrowthExponent = 0.35
    public static let inFlightDecodeFPSBoostExponent = 0.20
    public static let decodePacingMinimumMultiplier = 0.65
...
public enum ShadowClientRealtimeSessionDefaults {
    ...
    public static let videoDecodeQueueMaximumCapacity = 64
    ...
    public static let videoQueuePressureRecoveryMinimumOutputStallSeconds: TimeInterval = 0.45
