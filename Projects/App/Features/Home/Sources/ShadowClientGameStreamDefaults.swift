...
public enum ShadowClientVideoDecoderDefaults {
    ...
    public static let maximumInFlightDecodeRequests = 16
...
public enum ShadowClientRealtimeSessionDefaults {
    ...
    public static let videoDecodeQueueProducerTrimRecoveryDropThreshold = 24
    public static let videoDecodeQueueProducerTrimRecoveryCooldownSeconds: TimeInterval = 1.5
