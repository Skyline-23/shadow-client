...
enum ShadowClientRTSPAnnouncePayloadBuilder {
    static func build(
        ...
        let attributes: [(String, String)] = [
            ...
            ("x-shadow-video[0].clientDisplayGamut", clientDisplayCharacteristics.gamut.rawValue),
            ("x-shadow-video[0].clientDisplayTransfer", clientDisplayCharacteristics.transfer.rawValue),
            ("x-shadow-video[0].clientDisplayScalePercent", "\(clientDisplayCharacteristics.scalePercent)"),
            ("x-shadow-video[0].clientDisplayHiDPI", clientDisplayCharacteristics.hiDPIEnabled ? "1" : "0"),
            ("x-shadow-video[0].clientDisplayCurrentEDRHeadroom", "\(clientDisplayCharacteristics.currentEDRHeadroom)"),
            ("x-shadow-video[0].clientDisplayPotentialEDRHeadroom", "\(clientDisplayCharacteristics.potentialEDRHeadroom)"),
            ("x-shadow-video[0].clientDisplayCurrentPeakLuminanceNits", "\(clientDisplayCharacteristics.currentPeakLuminanceNits)"),
            ("x-shadow-video[0].clientDisplayPotentialPeakLuminanceNits", "\(clientDisplayCharacteristics.potentialPeakLuminanceNits)"),
