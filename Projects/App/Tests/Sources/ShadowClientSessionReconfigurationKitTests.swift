...
@Test("Session reconfiguration does not relaunch fixed-resolution sessions when audio sync mode is unchanged")
func sessionReconfigurationIgnoresRemovedAudioSynchronizationPolicy() {
    let previous = ShadowClientGameStreamLaunchSettings(
        width: 1920,
        height: 1080,
        fps: 60,
