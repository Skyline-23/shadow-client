...
@Test("Host ping payload parser returns nil for nil value")
...
@Test("Host ping payload parser returns nil for empty value")
...
@Test("Host ping payload parser returns nil when payload length is not 16 bytes")
...
@Test("Host ping payload parser accepts valid 16-byte payload")
...
@Test("Host ping payload parser strips quotes around payload")
...
@Test("Host ping payload parser ignores trailing parameters")
...
@Test("Host ping payload parser returns first 16-byte token")
...
@Test("Host control connect-data parser returns nil for nil value")
...
@Test("Host control connect-data parser parses decimal value")
...
@Test("Host control connect-data parser parses hex value")
...
@Test("Host control connect-data parser parses quoted hex value with trailing parameters")
...
@Test("Host control connect-data parser returns nil for malformed values")
